...
const navGroups: { label: string; items: NavItem[] }[] = [
  {
    label: "Teaching",
    items: [
      { href: "/admin/teaching", label: "My teaching" },
      { href: "/admin/recordings", label: "Recordings" },
      { href: "/admin/curriculum", label: "Curriculum" },
      { href: "/admin/syllabus", label: "Syllabus PDF (sales)" },
      { href: "/admin/syllabus-advisor", label: "Syllabus advisor" },
      { href: "/admin/content", label: "Notes editor" },
      { href: "/admin/assignments", label: "Projects & submissions" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/performance", label: "Candidate performance" },
