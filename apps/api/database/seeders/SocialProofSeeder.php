    ...
    private function questions(int $tenantId, int $courseId): void
    {
        $rounds = [
            ...
            [5, 'Scenario & project-based', [
                ...
                'A client requests real-time dashboards, but your system only supports batch processing. How will you redesign the pipeline to support near real-time analytics?',
                ...
                'You are asked to design a slowly changing dimension (SCD) Type 2 pipeline in Glue. How will you track history while keeping query performance acceptable?',
                ...
                'Your Spark streaming job is processing Kafka events, but there is a lag in consumer offsets. How do you debug and scale this job?',
                'Your data pipeline is built on AWS services. A region-wide outage occurs. How will you design for fault tolerance and high availability?',
                ...
                'If a pipeline completes 40% of the job but then fails, how do you ensure the rest completes without re-executing the first 40%?',
                ...
                'A new client has different data vendors and 15 key metrics that change weekly or monthly. How would you set up an ETL pipeline?',
                'Design a data pipeline for e-commerce — what tables and columns do you need?',
            ]],
        ];
