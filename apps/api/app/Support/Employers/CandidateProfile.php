    ...
    private function interview(?MockInterview $interview): ?array
    {
        ...
        return [
            ...
            'session' => [
                ...
                // Interviews are proctored operationally, but no integrity
                // signal reaches this payload yet: employer_interviews has no
                // column for focus loss, pasted answers or per-answer timing,
                // and quiz_attempts.integrity covers LMS quizzes only. Until
                // those signals are recorded against an employer round and
                // returned here, this stays false — reporting a clean session
                // we never measured is the one thing the trust firewall
                // exists to prevent. /for-employers describes the proctoring
                // an employer is promised; this screen must not claim it
                // until the data backs it up.
